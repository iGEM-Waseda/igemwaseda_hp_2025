...
export default function ProjectLogoLeftSide({ children, year, bgColor, projectTitle, ProjectTitleColor }: {
  ...
  return (
    <section className={`relative w-full ${bgColor}`} id={year}>
      <div className="grid grid-cols-1 md:grid-cols-3 md:aspect-[3/1]">
        <div className="relative md:col-span-1 aspect-square md:aspect-auto">
          <Image 
