...
export default function ProjectLogoRightSide({ children, year, bgColor, projectTitle, ProjectTitleColor, PrizesBadgeArray }: {
  ...
  return (
    <section className={`relative w-full ${bgColor}`} id={year}>
      <div className="grid grid-cols-1 md:grid-cols-5 md:aspect-[5/2]">
        ...
        <div className="hidden md:block relative md:col-span-2 aspect-square md:aspect-auto">
          <Image 
            src={`/project-${year}.png`} 
            alt={`Project ${year}`}  
            fill 
