  ...
  return (
    <>
      <button 
        ...
        className="flex items-center justify-between w-full px-6 py-4 md:py-6 text-sm md:text-lg border-b hover:bg-gray-100 border-gray-50 text-gray-700 hover:text-[#b94047] focus:outline-none"
      >
        {label}
          ...
          {items.map((item, index) => (
            <li key={item.href}>
              <Link 
                ...
                className="block py-3 md:py-4 pl-6 pr-6 text-xs md:text-base transition-colors hover:bg-gray-100 text-gray-700 hover:text-[#b94047]"
              >
                {item.label}
              </Link>
